...
<?php
    ...
    if($qtd > 0){
        ...
        while($row = $res->fetch_object() ){
            ...
            <button class='btn btn-danger' onclick=\"if(confirm('Tem certeza de que deseja excluir?')){location.href='?page=salvar-cliente&acao=excluir&id_cliente=".$row->id_cliente."';}\">Excluir</button>
            </td>");
            print("</tr>");
        }
        print("</table>");
